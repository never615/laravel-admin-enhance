...
class WangEditor extends Field
{
    ...
    protected $view = 'adminE::form.editor2';
    ...
    protected static $js = [
        '/vendor/laravel-adminE/plupload/plupload.full.min.js',
        '/vendor/laravel-adminE/qiniu/qiniu.js',
...
EOT;
    ...
    function uploadInit() {
        ...
        var editor1 = this;
        // 触发选择文件的按钮的id
        var btnId = editor1.customUploadBtnId;
        // 触发选择文件的按钮的父容器的id
        var containerId = editor1.customUploadContainerId;
        ...
        var uploader = Qiniu.uploader({
            ...
            flash_swf_url: '/vendor/laravel-admin/plupload/Moxie.swf',  //引入flash,相对路径
            filters: {
                    mime_types: [
                      //只允许上传图片文件 （注意，extensions中，逗号后面不要加空格）
                      { title: "图片文件", extensions: "jpeg,jpg,gif,png,bmp" }
                    ]
            },
            ...
            init: {
                ...
                'UploadProgress': function(up, file) {
                    // 显示进度条
                    editor1.showUploadProgress(file.percent);
                },
                'FileUploaded': function(up, file, info) {
                    ...
                    // 插入图片到editor
                    editor1.command(null, 'insertHtml', '<img src="' + sourceLink + '" style="max-width:100%;"/>')
                },
                'Error': function(up, err, errTip) {
                    //上传出错时,处理相关的事情
                    printLog('on Error');
                    notify.alert(3, err.message, 5);
                },
