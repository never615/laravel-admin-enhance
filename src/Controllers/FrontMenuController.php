        ...
        return Admin::content(function (Content $content) {
            ...
            $content->row(function (Row $row) {
                ...
                $row->column(6, function (Column $column) {
                    ...
                    $form->select('parent_id', trans('admin.parent_id'))->options(FrontMenu::selectOptions());
...
//                    $form->text('sub_title', "副标题");
    ...
    {
        return redirect()->route('front_menu.edit', ['id' => $id]);
    }
...
//            ->help("使用该菜单的主体,不设置表示所有主体都可以使用该菜单");
        ...
        $form->saving(function ($form) {
            ...
            $parent = FrontMenu::find($parentId);
            if ($parent) {
    ...
    public function destroy($id)
    {
        ...
        try {
            if ($this->form()->destroy($id)) {
                //同时删除所有的子菜单
                FrontMenu::where("parent_id", $id)->delete();
