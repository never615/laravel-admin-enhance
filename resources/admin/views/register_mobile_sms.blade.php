    ...
    <div class="register-box-body">
        ...
        <form action="{{ admin_url('auth/register') }}" method="post">
            <div class="form-group has-feedback {!! !$errors->has('mobile') ?: 'has-error' !!}">
                ...
                <input type="text" class="form-control" placeholder="{{ trans('admin3.mobile') }}"
                       onkeyup="value=value.replace(/[^\d]/g,'')" maxlength=11 name="mobile"
                       value="{{ old('mobile') }}">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback {!! !$errors->has('verify_number') ?: 'has-error' !!}">
                ...
                <input type="text" class="form-control" style="width: 225px;float: left "
                       placeholder="{{ trans('admin3.verify_number') }}" name="verify_number">
            ...
            <div class="form-group has-feedback {!! !$errors->has('company') ?: 'has-error' !!}">
                ...
                <input type="text" class="form-control" placeholder="{{ trans('validation.attributes.company') }}"
                       name="company">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    ...
                    <button type="submit"
                            class="btn btn-primary btn-block btn-flat">{{ trans('admin.submit') }}</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
